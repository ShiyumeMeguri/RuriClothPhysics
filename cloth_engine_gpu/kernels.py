...
SCL_EE_COUNT = _defs.SCL_EE_COUNT
SCL_PT_COUNT = _defs.SCL_PT_COUNT
SCL_IP_COUNT = _defs.SCL_IP_COUNT
SCL_ERROR = _defs.SCL_ERROR
SCL_USE_INTERSECT = _defs.SCL_USE_INTERSECT
SCL_FRAME_INDEX = _defs.SCL_FRAME_INDEX

MAX_SIM_COUNT = _defs.MAX_SIMULATION_COUNT_HIGH

SCAL_FRAME_DT = _defs.SCAL_FRAME_DT
SCAL_SIM_DT = _defs.SCAL_SIM_DT
SCAL_TIME_SCALE = _defs.SCAL_TIME_SCALE
SCAL_POWER0 = _defs.SCAL_POWER0
SCAL_POWER1 = _defs.SCAL_POWER1
SCAL_POWER2 = _defs.SCAL_POWER2
SCAL_POWER3 = _defs.SCAL_POWER3
SCAL_F_LEN = _defs.SCAL_F_LEN

SCAL_MAX_SIM = _defs.SCAL_MAX_SIM
SCAL_N_ZONES = _defs.SCAL_N_ZONES
SCAL_SUB_END = _defs.SCAL_SUB_END
SCAL_I_LEN = _defs.SCAL_I_LEN

WIND_ZONE_SLOTS = _defs.WIND_ZONE_SLOTS
ZONE_BOX = int32(_defs.ZONE_BOX)
ZONE_SPHERE_DIR = int32(_defs.ZONE_SPHERE_DIR)
ZONE_SPHERE_RADIAL = int32(_defs.ZONE_SPHERE_RADIAL)
...
DEG2RAD = float32(_defs.DEG2RAD)
RAD2DEG = float32(_defs.RAD2DEG)
...
BENDING_FIX_INV_MASS = float32(_defs.BENDING_FIXED_INVERSE_MASS)
ONE_SIXTH = float32(_defs.ONE_SIXTH)
TO_FIXED = float32(_defs.TO_FIXED)
