...
SLOT_BINDINGS = (
    ...
    ("p_intersect_flag", "particle", "intersect_flag"),
    ...
    ("p_normal_adjustment_rotations", "particle", "normal_adjustment_rotations"),
    ...
    ("p_out_rotations", "particle", "out_rotations"),
    ...
    ("p_vertex_to_transform_rotations", "particle", "vertex_to_transform_rotations"),
    ...
    ("sc_point_active", "derived", "solve_point_active"),
    ("sc_point_contact_count", "derived", "solve_point_contact_count"),
    ("sc_point_minimum_distance", "derived", "solve_point_minimum_distance"),
    ("sc_point_near_count", "derived", "solve_point_near_count"),
    ("sc_point_near_normal_sum", "derived", "solve_point_near_normal_sum"),
    ("sc_point_normal_sum", "derived", "solve_point_normal_sum"),
    ("sc_point_push_sum", "derived", "solve_point_push_sum"),
    ("sc_sync", "derived", "synchronization_snapshot"),
    ("sc_tri_normal_f64", "derived", "triangle_normal_double"),
    ("sc_tri_tangent_f64", "derived", "triangle_tangent_double"),
    ("scal_f", "frame_scalar", "frame_float"),
    ("scal_i", "frame_scalar", "frame_int"),
    ("scl_counts", "derived", "self_counters"),
    ...
    ("sfe_inv_mass", "self_edges", "inv_mass"),
    ("sfe_particles", "self_edges", "particles"),
    ("sfe_prim_depth", "self_edges", "prim_depth"),
    ("sfe_team", "self_edges", "team"),
    ("sfe_thickness", "self_edges", "thickness"),
    ...
    ("sfp_inv_mass", "self_points", "inv_mass"),
    ("sfp_particles", "self_points", "particles"),
    ("sfp_prim_depth", "self_points", "prim_depth"),
    ("sfp_team", "self_points", "team"),
    ("sfp_thickness", "self_points", "thickness"),
    ...
    ("sft_inv_mass", "self_triangles", "inv_mass"),
    ("sft_particles", "self_triangles", "particles"),
    ("sft_prim_depth", "self_triangles", "prim_depth"),
    ("sft_team", "self_triangles", "team"),
    ("sft_thickness", "self_triangles", "thickness"),
    ("sft_use", "self_triangles", "use"),
    ...
    ("st_triangle_particles", "triangles", "triangle"),
    ("st_triangle_team", "triangles", "team"),
    ("st_v2t_flip_normal", "v2t", "flip_normal"),
    ("st_v2t_flip_tangent", "v2t", "flip_tangent"),
    ("st_v2t_triangle", "v2t", "triangle"),
    ...
    ("t_self_cloth_mass", "team", "self_cloth_mass"),
    ("t_self_grid_size", "team", "self_grid_size"),
    ("t_self_max_primitive_size", "team", "self_max_primitive_size"),
    ("t_self_thickness_lut", "team", "self_thickness_lut"),
    ...
    ("t_use_edge", "team", "use_edge"),
    ("t_use_point", "team", "use_point"),
    ("t_use_triangle", "team", "use_triangle"),
    ("t_valid", "team", "valid"),
